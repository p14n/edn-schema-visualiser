...
sablono.util.ToString = (function (){var obj8239 = {};return obj8239;
})();
...
sablono.util.ToURI = (function (){var obj8241 = {};return obj8241;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__8242){
var xs = cljs.core.seq(arglist__8242);
...
{var vec__8244 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__8244,(0),null);var words = cljs.core.nthnext.call(null,vec__8244,(1));if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
*/
sablono.util.camel_case_keys = (function camel_case_keys(m){var f = (function (p__8247){var vec__8248 = p__8247;var k = cljs.core.nth.call(null,vec__8248,(0),null);var v = cljs.core.nth.call(null,vec__8248,(1),null);if((k instanceof cljs.core.Keyword))
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__8249_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__8249_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__8249_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__8249_SHARP_))
{return p1__8249_SHARP_;
} else
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__8249_SHARP_], null);
...
merge_with_class.cljs$lang$applyTo = (function (arglist__8250){
...
* CSS classes.
*/
sablono.util.match_tag = (function match_tag(s){var matches = cljs.core.re_seq.call(null,/[#.]?[^#.]+/,cljs.core.name.call(null,s));var vec__8254 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,("Can't match CSS tag: "+cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));var tag_name = cljs.core.nth.call(null,vec__8254,(0),null);var names = cljs.core.nth.call(null,vec__8254,(1),null);return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__8254,tag_name,names){
return (function (p1__8251_SHARP_){return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__8251_SHARP_));
});})(matches,vec__8254,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.util.strip_css,cljs.core.filter.call(null,((function (matches,vec__8254,tag_name,names){
return (function (p1__8252_SHARP_){return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__8252_SHARP_));
});})(matches,vec__8254,tag_name,names))
,names)))], null);
});
/**
...
*/
sablono.util.normalize_element = (function normalize_element(p__8255){var vec__8258 = p__8255;var tag = cljs.core.nth.call(null,vec__8258,(0),null);var content = cljs.core.nthnext.call(null,vec__8258,(1));if(!(((tag instanceof cljs.core.Keyword)) || ((tag instanceof cljs.core.Symbol)) || (typeof tag === 'string')))
...
{}
var vec__8259 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__8259,(0),null);var id = cljs.core.nth.call(null,vec__8259,(1),null);var class$ = cljs.core.nth.call(null,vec__8259,(2),null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"class","class",-2030961996),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
